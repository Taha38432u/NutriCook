...
import useGetNutrients from "./useGetNutrients.js";
...
function CheckNutrients() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-gray-900 via-gray-900 to-gray-900 p-6">
      <div className="w-full max-w-3xl rounded-3xl bg-gradient-to-br from-gray-800 to-gray-900 p-8 text-white shadow-2xl">
        ...
        <div className="mb-6 flex items-center gap-4">
          <input
            ...
            className="flex-grow rounded-lg bg-gray-800 p-3 text-white placeholder-gray-400 shadow focus:outline-none focus:ring-2 focus:ring-green-400"
          />
          <button
            onClick={addIngredient}
            className="flex items-center gap-2 rounded-lg bg-green-500 px-4 py-2 shadow-lg hover:bg-green-600"
          >
            <FaPlusCircle />
            Add
          </button>
